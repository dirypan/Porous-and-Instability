...
function J = customcolormap_preset(preset_name)
    ...
    switch(preset_name)
        ...
        case 'white-yellow-red'
            J = customcolormap([0 0.5 1],{'#cf1717','#c9cf17','#e0e0e0'});
        case 'red-white-blue2'
            J = customcolormap([0 0.33 0.5 0.66 1],{'#d92a07', '#e6bebe','#f5f5f5','#94b3d1', '#07afe3'});
        case 'red-white-blue3'
            J = customcolormap(linspace(0,1,11), {'#d30e31','#d30e31','#f3395a','#fbbcc7','#fde5ea','#ffffff','#d5e2f0','#93c5dc','#4295c1','#2265ad','#023f81'});
        case 'white-blue-red'
            % J = customcolormap([0 0.5 1],{'#C0392B', '#3498DB','#FFFFFF'});
              J = customcolormap([0 0.5 1],{'#FF2D00', '#0013FF','#FFFFFF'});
        otherwise
