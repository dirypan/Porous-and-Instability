...
for n = 0:5
    ...
    for i=1:200    
        ...
        for j = 1:N
            ...
            dr1Cond = (r1s(1)-dr1)<maxR1change;            
            dr2 = r2s(end) - alpha*Q/r2s(end).^n;
            dr2Cond = (r2s(1)-dr2)<maxR2change;
        ...
        p1 = plot((1./c1s)./(1./c1s+1./c2s),'-k'); hold on;
        p1.Color(4) = 0.2;
    ...
    ylabel('$(P_m - P_l) / (P_r - P_l )$','Interpreter','latex');
